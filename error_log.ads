...
package Error_Log is
   ...
   for_log : in out log_file; to : in wide_string);
...
private
   ...
   type file_access_ptr is access all Ada.Wide_Text_IO.File_Type;
   standard_error_file  : aliased Ada.Wide_Text_IO.File_Type;
   standard_output_file : aliased Ada.Wide_Text_IO.File_Type;
