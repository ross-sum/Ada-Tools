...
-- Error logging
   ...
   procedure Put(for_log : in log_file; the_error : in integer;
      ...
      -- Put the error introduction and error message into the log.
      -- Note that dStrings' append is used to avoid the storage error:
      -- 'raised STORAGE_ERROR : s-intman.adb:136 explicit raise' due to
